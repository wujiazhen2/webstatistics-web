...
<div class="right_content" style="margin-top: 135px" >
    ...
    <div class="right_content_sub" style="width: 40%;margin-top: 20px;padding:0px 20px;clear: left ">
        <div id="originPie" class="echart_div" style="height: 300px"></div>
    </div>
    <div class="right_content_sub" style="width: 60%;float: right;">
        <div id="originLine" class="echart_div" style="height: 300px"></div>
    </div>
</div>
<div class="right_content">
    <table id="originTable" class="table table-striped table-bordered table-hover my_table"></table>
</div>
...
<script src="../js/originClassify.js"></script>
</body>
</html>